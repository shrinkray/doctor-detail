...
<div class="bg-white">
  <div class="max-w-7xl mx-auto py-24 sm:px-2 sm:py-32 lg:px-4">
    <div class="max-w-2xl mx-auto px-4 lg:max-w-none">
      <div class="max-w-3xl">
        <h2 class="text-4xl font-extrabold tracking-tight text-gray-900">We built our business on customer service</h2>
      ...
      <div class="mt-16 grid grid-cols-1 gap-y-10 gap-x-8 lg:grid-cols-3">
        <div class="sm:flex lg:block">
          ...
          <div class="mt-4 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
            ...
            <p class="mt-2 text-md text-gray-500">
              We know your car is an extension of your personality. It's the extra touches that make it so special.
            </p>
          </div>
        </div>
        ...
        <div class="sm:flex lg:block">
          ...
          <div class="mt-4 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
            ...
            <p class="mt-2 text-md text-gray-500">
              We love our repeat customers. We want to make sure they're happy with their experience.
            </p>
          </div>
        </div>
        ...
        <div class="sm:flex lg:block">
          ...
          <div class="mt-4 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
            ...
            <p class="mt-2 text-md text-gray-500">
              Beauty is in the eye of the beholder. And for everyone else they want to be you.
            </p>
          </div>
        </div>
      </div>
